...
function MenuOverlay({ children, isOpen = false, setIsOverlayOpen }, ref) {
  return (
    <div
      className={clsx(
        'fixed left:0 md:left-20 bottom:16 md:bottom-auto md:top-0 w-full h-full bg-gradient-to-br from-red-300 to-pink-300 text-white z-40 px-8 pt-7 md:px-36 xl:px-48 md:pt-20 xl:pt-28 2xl:pt-40 pb-4 md:pb-20 xl:pb-28 2xl:pb-48 flex flex-col max-h-screen',
        !isOpen && 'hidden'
      )}
      ref={ref}
    >
